...
- **GPX QR код**: генерация QR-кода со ссылкой на GPX для своих тренировок.
- **Фильтр по дистанции**: настройка минимальной дистанции (км) для создания QR-кода.
...
- таймер умной стратегии;
- GPX QR код (вкл/выкл, пароль загрузки, мин. дистанция);
